#!/usr/bin/env bash
# Install script for Linux – ensures Python 3.12+, uv, and project .venv are ready.
...
if [[ -z "$PYTHON" ]]; then
  ...
  echo "  Debian/Ubuntu: sudo apt update && sudo apt install python3.12 python3.12-venv"
